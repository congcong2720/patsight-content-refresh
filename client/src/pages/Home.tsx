...
const copy = {
  zh: {
    ...
    caseDesc: "浏览 PatSight 在专利情报、分子数据提取与药物研发等不同场景中的案例与专业洞察。",
    caseCta: "浏览更多案例",
  ...
  en: {
    ...
    caseDesc: "Discover real-world applications and expert insights across patent intelligence, molecular data extraction, and drug discovery.",
    caseCta: "Explore more cases",
